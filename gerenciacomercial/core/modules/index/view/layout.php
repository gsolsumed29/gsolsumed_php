    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather='circle'></i><span class="menu-title text-truncate" data-i18n="User">Indicadores</span></a>
                    <ul class="menu-content">                    
                        <li class="i_parametros"><a class="d-flex align-items-center" href="index.php?view=parametros"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="View">Parametros</span></a>
                        </li>                                          
                    </ul>                   
                </li>

                  
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather='calendar'></i><span class="menu-title text-truncate" data-i18n="User">Plafinicaciones</span></a>
                    <ul class="menu-content">                    
                        <li class="i_planificaciones"><a class="d-flex align-items-center" href="index.php?view=planificaciones"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="View">Consultar</span></a>
                        </li>                                          
                    </ul>                   
                </li>

                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather='map-pin'></i><span class="menu-title text-truncate" data-i18n="User">Visitas</span></a>
                    <ul class="menu-content">
