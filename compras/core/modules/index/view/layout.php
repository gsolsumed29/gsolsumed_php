...
<head>
 ...
 <!-- BEGIN: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="../compras/css/style.css">
    <!-- END: Custom CSS-->
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather='search'></i><span class="menu-title text-truncate" data-i18n="User">Articulos</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="index.php?view=precios"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Precios</span></a>
                        </li>
