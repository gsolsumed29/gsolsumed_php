...
class ReporteData {
	public static $tablename = "reporte";	
		...
		public static function generarReportePedido($reci_num,$status){	
			...
			$pdf->setY(10);
			$pdf->setX(40);	
		//	$pdf->Cell(279,45,"Grupo solsumed, CA",0,0,"L");
			$pdf->SetFont('Arial','B',15);    
			$pdf->setX(10);	
			$pdf->Cell(279,30,"RECIBO DE PAGO NOMINA",1,0,"C");			
			$pdf->Image('../app-assets/images/logo/logo_recibo.png' , 15 ,15, 65 , 20,'PNG');
		...
		//	$pdf->Cell(150,50,utf8_decode('He recibido conforme: '.$totalLetras.''),0,1,'FJ',0);
		...
		public static function generarReporteConstanciaTrabajo($idConstancia,$status){			
		  ...
		  $meses_ES = array("Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre");
			...
			$pdf->SetFont('Arial','B',10);  
				...
				$pdf->Cell(3,$textypos,utf8_decode('Carrera 19 N° 56-26 - Teléfono 0251-442.63.01'));
				$pdf->setY(45);$pdf->setX(10);
				$pdf->Cell(3,$textypos,utf8_decode('BARQUISIMETO - ESTADO LARA'));       
				$pdf->setY(50);$pdf->setX(10);
				$pdf->Cell(3,$textypos,utf8_decode('iccolegiosanpedro@gmail.com'));
			...
			$pdf->Image('../app-assets/images/logo/top.png' , 10 ,10, 100 , 15,'PNG');
		...
		// 1988-06-07
			...
			$pdf->setY(80);
				...
				$pdf->setY(100);
				$pdf->Cell(130,5,utf8_decode('y devenga un sueldo mensual de BS.: '.$result2[0]->promedio.'.'),0,1,'FJ',0);
		   ...
		   $pdf->Cell(75,5,utf8_decode('el '. fechaCastellano($result2[0]->fecha_emision).'.'),0,1,'FJ',0);	
					   ...
					   $pdf->setY(170); 	
					   $pdf->setX(85);  
					   $pdf->Cell(5,$textypos,utf8_decode('C.I : V-7.888.608'));  
					  ...
					  $pdf->Cell(130,5,utf8_decode('09 de Diciembre de 2024 - Bicentenario de la Batalla de Ayacucho'),0,1,'FJ',0);
