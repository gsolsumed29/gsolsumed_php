                        ...
                        <div class="modal-dialog sidebar-sm">
                            <form class="add-new-record-usuario modal-content pt-0">
                                ...
                                <div class="modal-body flex-grow-1">
                                    ...
                                    <div class="mb-1">
                                        <label class="form-label" for="basic-icon-default-email">Empleado</label>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="email" class="form-control  email" name="email" placeholder="usuario@gmail.com" id="email" />
                                    </div>   
                                    ...
                                    <button type="button" class="btn btn-relief-primary data-submit-usuario me-1"> <i data-feather='save'></i> Guardar</button>
