...
class PagoRegData {
	...
	$sql ="INSERT INTO ".self::$tablename."(nro_doc,cob_num, reng_num, forma_pag, cod_ban, ref_ban, fec_tran, cod_caja, monto,monto_bs,tasa,tipo_moneda,tipo_doc,status) ";
	$sql.=" VALUES('$this->nro_doc','$this->cob_num','$item','$this->forma_pag','$this->cod_ban','$this->ref_ban','$this->fec_tran','$this->cod_caja',$this->monto,$this->monto_bs,$this->tasa,'$this->tipo_moneda','$this->tipo_doc',1)";
	//echo "<br>";
	//echo $sql;
		Executor::doitEx($sql);		
		$item++;
	...
	public static function ultima(){		
		...
		$sql = "SELECT  MAX(cob_num) as co_pago FROM jm_reportar_pago";
		//echo $sql;
