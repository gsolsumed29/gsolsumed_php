...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static   menu-collapsed user localizacion" data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-light navbar-shadow container-xxl">        
        ...
        <div class="bookmark-wrapper d-flex align-items-center">
                ...
                <ul class="nav navbar-nav bookmark-icons"> 
                    <li><h4 class="brand-text name" id="name"></h4></li>
                </ul>
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder" id="user_name"><?php  if(isset($_SESSION['nombre'])){
        ...
        Action::execute("salir",array());
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                            <a class="dropdown-item" href="#" style="display:none">
                             <i class="me-50" data-feather='circle'></i><span class="co_alma" ></span>
                            </a>   
                           
                            <a class="dropdown-item" href="#" style="display:none">
                             <i class="me-50" data-feather='circle'></i><span class="almacen"></span>
                            </a>    
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather='archive'></i><span class="menu-title text-truncate" data-i18n="User">Recibos</span></a>
                    <ul class="menu-content">
                        <li class="i_clientes"><a class="d-flex align-items-center " href="index.php?view=nominas"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Nominas</span></a>
                        </li>
                        <li class="i_articulos"><a class="d-flex align-items-center" href="#"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Alimentacion</span></a>
                        </li>    
                        <li class="i_cuentas"><a class="d-flex align-items-center" href="#"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Vacaciones</span></a>
                        </li>   
                                                        
                    </ul>
                </li>

                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather='search'></i><span class="menu-title text-truncate" data-i18n="User">Constancias</span></a>
                    <ul class="menu-content">
                        <li class="i_clientes"><a class="d-flex align-items-center " href="#" data-bs-toggle="modal" data-bs-target="#modalAddPersonalConstancia" ><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Trabajo</span></a>
                        </li>
                     
                                                        
                    </ul>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather='printer'></i><span class="menu-title text-truncate" data-i18n="User">Solicitudes</span></a>
                    <ul class="menu-content">
                        <li class="i_clientes"><a class="d-flex align-items-center " href="index.php?view=documentos"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Listado general</span></a>
                        </li>
    ...
    <!-- END: Main Menu-->
                    ...
                    <div class="modal modal-slide-in fade modalAddPersonalConstancia" id="modalAddPersonalConstancia">
                        <div class="modal-dialog sidebar-sm">
                            <form class="frmAddPersonalConstancia modal-content pt-0">
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">×</button>
                                <div class="modal-header mb-1">
                                    <h5 class="modal-title" id="exampleModalLabel">Datos Generar</h5>
                                </div>
                                <div class="modal-body flex-grow-1">
                                     ...
                                     <div class="mb-1">
                                        ...
                                        <select class="select2 form-select cmbAddPersonalConstanciaTipo" id="cmbAddPersonalConstanciaTipo" name="cmbAddPersonalConstanciaTipo">
                                                            <option value="0">Seleccione</option>                                                          
                                                            <option value="1">A quien pueda</option>   
                                                            <option value="2">Dirigida A</option>                                                                                    
                                        </select>
                                    </div>     
                                    <div class="frmDirigidoA" style="display:none">
                                        
                                       
                                    <div class="mb-1">
                                        <label class="form-label" for="basic-icon-default-email">Dirigido A *</label>
                                        <textarea data-length="30" class="form-control char-textarea textAreaAddPersonalConstanciaAsunto" id="textAreaAddPersonalConstanciaAsunto" rows="3" placeholder="Dirigido A : Sr(es)" style="height: 100px"  name="textAreaAddPersonalConstanciaAsunto"></textarea>
                                    ...
                                    <button type="button" class="btn btn-primary btnAddPersonalConstancia me-1">Solicitar</button>
...
?>
  ...
  <!-- BEGIN: Footer-->
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2023<a class="ms-25" href="#" target="_blank">Soluciones Jm</a><span class="d-none d-sm-inline-block">, Reservados todos los derechos</span></span><span class="float-md-end d-none d-md-block">jmobile ver 5.0</span></p>
    </footer>
