...
class ReporteData {
	public static $tablename = "reporte";	
		...
		public static function generarReportePedido($fact_num,$status,$co_ven){			
		...
		public static function generarReporteEnviar($fact_num,$status,$co_ven){	
