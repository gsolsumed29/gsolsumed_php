        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="content-body">
                <div class="row" id="dashboard">
                    ...
                    <div class="col-lg-12 col-md-12 col-12 noFacturadosTable">
                            <div class="card">
                            <div class="card-header border-bottom">
                                    <h4 class="card-title">Clientes no Facturados</h4>
                                </div>
                ...
                <section id="basic-datatable">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                            <div class="card-header border-bottom">
                                    <h4 class="card-title">Ventas del mes por dias </h4>
                                    <div class="d-flex align-items-center"> 
                                    <button type="button" class="btn btn-relief-success totalMonto">Success</button>
                                    &nbsp;  &nbsp;
                                    <button type="button" class="btn btn-relief-info totalPeso">Success</button>                                  
                                 
                                    </div>
                                </div>
                             
                                <table class="datatables-basic-ventas-dia table">
                                    <thead>
                                        <tr>
                                        ...
                                        <form class="add-new-record modal-content pt-0">
                                            ...
                                            <div class="modal-body flex-grow-1">                                         
                                                ...
                                                <div class="mb-1">
                                                    <label class="form-label" for="basic-icon-default-date">Vendedor</label>
                                                    <div class="position-relative" data-select2-id="45">
                                                    <select class="select2  form-select border-0 shadow-none bg-transparent pe-0 comboVendedoresMenosVendidos" id="select2-basic-2">   
                                                    <option value="NO">Todos</option>                                        
                                                    </select>
                                                    </div>
                                                </div>
                                                <div class="mb-1">
                                                    <label class="form-label" for="basic-icon-default-date">Zona</label>
                                                    <div class="position-relative" data-select2-id="45">
                                                    <select class="select2  form-select border-0 shadow-none bg-transparent pe-0 comboZonaMenosVendidos">   
                                                    <option value="NO">Todas</option>                                        
                                                    </select>
                                                    </div>
                                                </div>
                                        ...
                                        <form class="add-new-record modal-content pt-0">
                                            ...
                                            <div class="modal-body flex-grow-1">                                         
                                                ...
                                                <div class="mb-1">
                                                    <label class="form-label" for="basic-icon-default-date">Vendedor</label>
                                                    <div class="position-relative" data-select2-id="45">
                                                    <select class="select2  form-select border-0 shadow-none bg-transparent pe-0 comboVendedoresMayorUtilidad" id="select2-basic-3">   
                                                    <option value="NO">Todos</option>                                        
                                                    </select>
                                                    </div>
                                                </div>
                                                <div class="mb-1">
                                                    <label class="form-label" for="basic-icon-default-date">Zona</label>
                                                    <div class="position-relative" data-select2-id="45">
                                                    <select class="select2  form-select border-0 shadow-none bg-transparent pe-0 comboZonaMayorUtilidad">   
                                                    <option value="NO">Todas</option>                                        
                                                    </select>
                                                    </div>
                                                </div>
                                        ...
                                        <form class="add-new-record modal-content pt-0">
                                            ...
                                            <div class="modal-body flex-grow-1">                                         
                                                ...
                                                <div class="mb-1">
                                                    <label class="form-label" for="basic-icon-default-date">Vendedor</label>
                                                    <div class="position-relative" data-select2-id="45">
                                                    <select class="select2  form-select border-0 shadow-none bg-transparent pe-0 comboVendedoresMenorUtilidad" id="select2-basic-4">   
                                                    <option value="NO">Todos</option>                                        
                                                    </select>
                                                    </div>
                                                </div>
                                                <div class="mb-1">
                                                    <label class="form-label" for="basic-icon-default-date">Zona</label>
                                                    <div class="position-relative" data-select2-id="45">
                                                    <select class="select2  form-select border-0 shadow-none bg-transparent pe-0 comboZonaMenorUtilidad">   
                                                    <option value="NO">Todas</option>                                        
                                                    </select>
                                                    </div>
                                                </div>
                                        ...
                                        <form class="add-new-record modal-content pt-0">
                                            ...
                                            <div class="modal-body flex-grow-1"> 
                                                ...
                                                <div class="mb-1">
                                                    <label class="form-label" for="basic-icon-default-date">Vendedor</label>
                                                    <div class="position-relative" data-select2-id="45">
                                                    <select class="select2  form-select border-0 shadow-none bg-transparent pe-0 comboVendedoresClientesFacturados" id="select2-basic-6">   
                                                    <option value="NO">Todos</option>                                        
                                                    </select>
                                                    </div>
                                                </div>
                    ...
                    <div class="row match-height">
                            <input type="hidden" id="dataMeses" class="dataMeses" value=''>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        <div class="card card-transaction">
                                            <div class="card-header">
                                                <h4 class="card-title">CLIENTES ALTOS </h4>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        <div class="card card-transaction">
                                            <div class="card-header">
                                                <h4 class="card-title">CLIENTES MENOS VENDIDOS </h4>
