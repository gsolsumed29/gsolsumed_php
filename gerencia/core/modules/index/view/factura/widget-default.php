    ...
    <?php 
      ...
      $result = $objeto_pedido->GetPedido($fact_num,$status,$co_ven);
      //var_dump($result);
      if(!empty($result)){
                ...
                <section class="invoice-preview-wrapper">
                    <div class="row invoice-preview" >
                            ...
                            <div class="card invoice-preview-card">
                                <div class="card-body invoice-padding pb-0">
                                    ...
                                    <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                                        <div>
                                            <h3 class="text-primary invoice-logo name2" id="name2" ></h3>
                                            <p class="card-text mb-25 rif" id="rif"></p>
                                            <p class="card-text mb-25 direccion" id="direccion"></p>
                                            <p class="card-text mb-25 email" id="email"></p>
                                            <p class="card-text mb-0 telefonos" id="telefonos"></p>
                                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <?php 
                                             $result2 = $objeto_pedido->GetRenglonPedido($fact_num,$co_ven);
                                            $totalArticulos = 0;
                                           // var_dump( $result);
                                    ...
                                    <div class="row invoice-sales-total-wrapper">
                                        <div class="col-md-6 order-md-1 order-2 mt-md-0 mt-3">
                                            <p class="card-text mb-0">
                                                <span class="fw-bold">Vendedor:</span> <span class="ms-75"><?php echo $co_ven?></span>
                                            </p>
                                        </div>
                        ...
                        <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
                            <div class="card">
                                <div class="card-body">                                    
                                <a class="btn btn-relief-success w-100 mb-75" href="index.php?action=reporte&tipo=1&fact_num=<?php echo $fact_num;?>&status=<?php echo $status;?>&co_ven=<?php echo $co_ven;?>" target="_blank"> <i data-feather='file-text'></i> Generar Pdf </a>                                  
                                <?php if(isset($status)){
                                        if($status==0){
                                    ?>
                                    <button class="btn btn-relief-warning w-100 mb-75 anularPedido" id = "anularPedido">
                                    <i data-feather='alert-circle'></i> Anular Pedido <span class="total_articulos_anular" style="display:none"><?php echo $totalArticulos; ?> <span class="fact_num_anular" style="display:none"><?php echo $fact_num; ?></span>
                                    </button>    
                                  
                                    <button class="btn btn-relief-danger w-100 mb-75 eliminarPedido" id = "eliminarPedido">
                                    <i data-feather='x-circle'></i> Eliminar Pedido <span class="total_articulos_eliminar" style="display:none"><?php echo $totalArticulos; ?> <span class="fact_num_eliminar" style="display:none"><?php echo $fact_num; ?></span>
                                    </button>                                                             
                                     <?php
                                        }
                                }
