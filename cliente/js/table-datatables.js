...
function cargarTablaPagosRealizados($cliente) {
  ...
  // Definición de SVGs para reemplazar feather.icons
  // Mantienen las mismas clases para estilo (font-small-4, me-50) y tamaño visual
  const svgShare = '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="font-small-4 me-50"><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"></path><polyline points="16 6 12 2 8 6"></polyline><line x1="12" y1="2" x2="12" y2="15"></line></svg>';
  
  const svgFile = '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="font-small-4 me-50"><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path><polyline points="13 2 13 9 20 9"></polyline></svg>';
  
  const svgClipboard = '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="font-small-4 me-50"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path><rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect></svg>';
  
  const svgTrash = '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="font-small-4 me-50"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg>';
  ...
  if (dt_basic_table_facturaciones.length) {
    ...
    var dt_basic = dt_basic_table_facturaciones.DataTable({
      ...
      order: [[4, 'desc']],
       dom: '<"card-header d-flex justify-content-between align-items-center"<"head-label"><"dt-action-buttons ms-auto"B>><"d-flex justify-content-between align-items-center mx-0 row"<"col-sm-12 col-md-6"l><"col-sm-12 col-md-6"f>>t<"d-flex justify-content-between mx-0 row"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
      displayLength: 7,
      lengthMenu: [7, 10, 25, 50, 75, 100],
      buttons: [
...
async function enviarPagosConArchivos(pagosRegistrados) {
  try {
      ...
      if (response.success) {
         ...
         // window.location.href = 'index.php?view=facturas'; 
          //29012026
...
async function enviarPagos(pagosRegistrados, retenciones) {
  ...
  try {
      ...
      const response = await $.ajax({
          url: '../admin/index.php?action=mpago&tipo=1&accion=1&datos=2',
          type: 'POST',
          dataType: 'json',
          data: {
...
function perfilCliente($co_cli){
  ...
  if(tope>=1){  
   ...
   if (data[0].id_estado) { // Habilitar todos los combos
...
function buscarDataReferencia(referencia) {
    $.ajax({
        type: "GET",
        url: '../admin/index.php?action=combos&c=FuncionesData&a=10011&tabla=jm_reportar_pago_reg&campo=ref_ban&dato=' + referencia, 
    }).done(function(data) { 
