    ...
    <?php 
	  ...
	  $fact_num_2= $objeto_f->reconvertirNumeroFactura($fact_num);
                
      $objeto_pedido = New FacturaData();          
      $result = $objeto_pedido->GetFacturaCliente($fact_num_2);
      //var_dump($result);
      if(!empty($result)){
                            ...
                            <div class="card invoice-preview-card">
                                    ...
                                    <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                                        ...
                                        <div class="mt-md-0 mt-2">
                                            <h4 class="invoice-title">
                                                Factura
                                                <span class="invoice-number" id="invoice-number" >#<?php echo $fact_num?></span>
                                            </h4>
                                ...
                                <div class="card-body invoice-padding pt-0">
                                    <div class="row invoice-spacing">
                                        <div class="col-xl-8 p-0">
                                            ...
                                            <h6 class="mb-25"></h6>
                                            <p class="card-text mb-25"><?php echo $result[0]->cli_des; ?></p>
                                            <p class="card-text mb-25"><?php echo $result[0]->rif; ?></p>
                                            <p class="card-text mb-25"><?php echo $result[0]->email; ?></p>
                                            <p class="card-text mb-0"><?php echo $result[0]->direc1; ?></p>
                                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <?php 
                                             $result2 = $objeto_pedido->GetRenglonFacturaCliente($fact_num_2);
                                            $totalArticulos = 0;
                                           // var_dump( $result);
                                           foreach($result2 as $dato){
                                            ...
                                            ?>
                                                ...
                                                <td class="py-1">
                                                  ...
                                                  <td class="py-1">
                                                    <p class="card-text fw-bold mb-25"><?php echo  $marca ?></p>
                                        ...
                                        <div class="col-md-6 d-flex justify-content-end order-md-2 order-1">
                                            <div class="invoice-total-wrapper">
                                                ...
                                                <div class="invoice-total-item">
                                                    ...
                                                    <p class="invoice-total-amount"><?php echo $result[0]->glob_desc; ?></p>
                                                </div>
                                                <hr class="my-50" />
                                                <div class="invoice-total-item">
