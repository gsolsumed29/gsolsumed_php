 ...
 <?php
   ...
   $tipo_doc_msg = "FACTURAS";
    ...
    $tipo_doc_msg = "NOTAS N/CR Y N/DB ADMINISTRATIVAS";
   }elseif($tipo_doc ==5){
  ...
  ?>
        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="content-body">
               ...
               <input type="hidden" id="dataDocumentosNotas" class="dataDocumentosNotas" value=''>
                <!-- Basic table -->
            <section id="responsive-datatable">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <table class="dataTableDocumentosNotas dt-responsive table">
                                    <thead>
                                       <tr> 
