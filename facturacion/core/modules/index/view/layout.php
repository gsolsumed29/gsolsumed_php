    ...
    <nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-light navbar-shadow container-xxl">        
        ...
        <div class="bookmark-wrapper d-flex align-items-center">
            ...
            <li class="nav-item dropdown dropdown-notification me-25">
                <a class="nav-link" href="#" id="badgeFacturasLink">
                    <i class="ficon" data-feather="bell"></i>
                    <span class="badge rounded-pill bg-danger badge-up" id="alertFacturas" style="display: none;">0</span>
                </a>
            </li>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather='printer'></i><span class="menu-title text-truncate" data-i18n="Card">Documentos</span></a>
                    <ul class="menu-content">                
                       
                        <li><a class="d-flex align-items-center" href="index.php?view=documentos&tipo_doc=1"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Emitidos</span></a>
                        </li>  
