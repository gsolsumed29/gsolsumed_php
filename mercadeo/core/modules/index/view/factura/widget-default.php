                ...
                <section class="invoice-preview-wrapper">
                    <div class="row invoice-preview" >
                                    ...
                                    <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                                        ...
                                        <div class="mt-md-0 mt-2">
                                            <h4 class="invoice-title">
                                                Numero de control: 
                                                <span class="invoice-number">00 - <?php echo $fact_num?></span>
                                            </h4>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><span class="fw-bold">
                                                            <?php echo number_format($result[0]->tot_bruto, 2, ',', '.'); ?></span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="pe-1">Iva:</td>
                                                        <td><?php echo number_format($result[0]->iva, 2, ',', '.'); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="pe-1">Total:</td>
                                                        <td><?php echo  number_format($result[0]->tot_neto, 2, ',', '.'); ?></td>
                                                    </tr>
                                        ...
                                        <div class="col-md-6 d-flex justify-content-end order-md-2 order-1">
                                            <div class="invoice-total-wrapper">
                                                <div class="invoice-total-item">
                                                    ...
                                                    <p class="invoice-total-amount"> <?php echo number_format($result[0]->tot_bruto, 2, ',', '.'); ?></p>
                                                </div>     
                                                <!--                                          
                                                <div class="invoice-total-item">
                                                    <p class="invoice-total-title">Iva:</p>
                                                    <p class="invoice-total-amount"><?php echo number_format($result[0]->iva, 2, ',', '.'); ?></p>
                                                </div>
                                                  -->
                                                <hr class="my-50" />
                                                <div class="invoice-total-item">
                                                    <p class="invoice-total-title">Total:</p>
                                                    <p class="invoice-total-amount"><?php echo  number_format($result[0]->tot_neto, 2, ',', '.'); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
                            <div class="card">
                                <div class="card-body">                                    
                                <a class="btn btn-relief-success w-100 mb-75" href="index.php?action=reporte&tipo=1&fact_num=<?php echo $fact_num; ?>&status=<?php echo $status; ?>" target="_blank"> <i data-feather='file-text'></i> Generar Pdf </a>                                  
                                <?php if(isset($status)){
                                        if($status==0){
                                    ?>
