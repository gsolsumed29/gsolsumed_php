                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="index.php?view=visitas">Candidatos</a>
                                    </li>
                ...
                <div class="card-body p-1">
                    <form class="validate-form">
                        ...
                        <div class="mb-1">
                            ...
                            <div class="row g-2">
                                <div class="col-md-6">
                                    <label class="form-label fw-bold">Correo del espacio  fisico (Comercio) <span class="text-danger"></span></label>
                                    <div class="input-group input-group">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-bold">Teléfono del espacio fisico (Comercio)<span class="text-danger"></span></label>
                                    <div class="input-group input-group">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="mb-1 photo-section">
                                    ...
                                    <label for="fotoPuntoVenta">
                                        <h5>Fotografía del establecimiento</h5>
