...
<!-- Modal de Visitas Diarias (modificado) -->
<div class="modal fade" id="dailyVisitsModal" tabindex="-1" role="dialog" aria-labelledby="dailyVisitsModalTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary text-white">
        <h5 class="modal-title  text-white" id="dailyVisitsModalTitle">
          <i class="fas fa-clipboard-list me-1"></i> 
          Visitas del Día: <span id="selectedDateDisplay"></span>
        </h5>
      ...
      <div class="modal-body">      
        ...
        <div class="table-responsive">
          <table class="table table-hover table-bordered" id="dailyVisitsTable">
      ...
      <div class="modal-footer">
        <div class="w-100 d-flex justify-content-between align-items-center">
          <button type="button" class="btn btn-success" id="exportPDFBtn">
            <i data-feather='printer'></i></i> Exportar a PDF
          </button>
          <button type="button" class="btn btn-secondary" data-dismiss="modal">
            <i data-feather='x-circle'></i></i> Cerrar
          </button>
        </div>
      </div>
    </div>
