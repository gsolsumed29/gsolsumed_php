            ...
            <div class="content-body">
                ...
                <div class="row match-height">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-6 mb-1 d-flex align-items-end">
                                        <button class="btn btn-primary w-100" onclick="updateDashboard()">Aplicar Filtros</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-6 col-lg-12">
                        <div class="card dashboard-responsive-card">
                            <div class="card-body">
                                <h5 class="card-title">Facturación vs Cobranzas</h5>
                                <div class="dashboard-chart-container">
                                    <canvas id="facturacionCobranzasChart"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card dashboard-responsive-card">
                            <div class="card-body">
                                <h5 class="card-title">Top 5 Productos Más Facturados</h5>
                                <div class="dashboard-chart-container">
