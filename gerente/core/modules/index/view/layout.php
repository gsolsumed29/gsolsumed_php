            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
              ...
              <!--  <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather='search'></i><span class="menu-title text-truncate" data-i18n="User">Consulta</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="index.php?view=clientes"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Clientes</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="index.php?view=articulos"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Artículos</span></a>
                        </li>    
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather='dollar-sign'></i><span class="menu-title text-truncate" data-i18n="User">Cobranzas</span></a>
                    <ul class="menu-content">
                        <li class="i_adelantos"><a class="d-flex align-items-center" href="index.php?view=adelantos"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Adelantos</span></a>
                        </li>
                        <li class="i_cobros"><a class="d-flex align-items-center" href="index.php?view=cobros"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Cobros</span></a>
                        </li>    
