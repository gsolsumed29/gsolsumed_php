 ...
 <!-- BEGIN: Vendor CSS-->
  ...
  <link rel="stylesheet" href="https://unpkg.com/leaflet@1.7.1/dist/leaflet.css" />
    <link rel="stylesheet" type="text/css" href="../assets/css/style.css">
        <link rel="stylesheet" type="text/css" href="../inventario/css/style.css">
    ...
    <nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-light navbar-shadow container-xxl">        
        ...
        Action::execute("salir",array());
                    ...
                    <div class="dropdown-menu dropdown-menu-end drop_nav" aria-labelledby="dropdown-user">
                            ...
                            <span class="nivel" style="display:none"><?php  echo $_SESSION['nivel']?></span>
                            <a class="dropdown-item" href="#" style="display:none">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather='search'></i><span class="menu-title text-truncate" data-i18n="User">Verificaciones</span></a>
                    <ul class="menu-content">
                    
                        <li class="i_despachos_consulta"><a class="d-flex align-items-center " href="index.php?view=despachos"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Consultar</span></a>
                        </li>      
                        
                          <!--<li class="i_despachos_consulta_rutas"><a class="d-flex align-items-center " href="index.php?view=ruta"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Ruta</span></a>
                        </li>        -->   
                    </ul>
                </li>
                  
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather='truck'></i><span class="menu-title text-truncate" data-i18n="User">Embarcos</span></a>
                    <ul class="menu-content">
                    
                        <li class="i_embarcos_consulta"><a class="d-flex align-items-center " href="index.php?view=embarcos"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Consultar</span></a>
                        </li>      
                         <li class="i_entregas_consulta"><a class="d-flex align-items-center " href="index.php?view=entregas"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Entregas</span></a>
                        </li>    
                          <!--<li class="i_despachos_consulta_rutas"><a class="d-flex align-items-center " href="index.php?view=ruta"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Ruta</span></a>
                        </li>        -->   
                    </ul>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather='printer'></i><span class="menu-title text-truncate" data-i18n="User">Reportes</span></a>
                    <ul class="menu-content">
                    
                        <li class="i_analisis_general"><a class="d-flex align-items-center " href="index.php?view=analisis"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Analisis general</span></a>
                        </li>      
                        <!-- <li class="i_entregas_consulta"><a class="d-flex align-items-center " href="index.php?view=entregas"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Entregas</span></a>
                        </li>    -->
                          <!--<li class="i_despachos_consulta_rutas"><a class="d-flex align-items-center " href="index.php?view=ruta"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Ruta</span></a>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js"></script>
 ...
 <script src="js/embarco.js"></script>
