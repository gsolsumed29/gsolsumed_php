...
?> 
<div class="app-content content  m_embarco_item datosCargaVehiculo" id="datosCargaVehiculo">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       ...
                                       <select class="form-select ayudante" id="ayudante"> 
                                            <option value="" disabled selected>Seleccionar ayudante</option>
                                            <option value="CARLOS CORDERO - 14.335.022">CARLOS CORDERO - 14.335.022</option>
                                            <option value="CARLOS PERAZA - 20.540.775">CARLOS PERAZA - 20.540.775</option>
                                            ...
                                            <option value="DEIBI VARGAS- 20.922.790">DEIBI VARGAS- 20.922.790</option>  
                                            ...
                                            <option value="FRANCOI AMARO - 11.784.811">FRANCOI AMARO - 11.784.811</option>
                                            ...
                                            <option value="TRANSPORTE EXTERNO - 00.000.000">TRANSPORTE EXTERNO - 00.000.000</option>
                                        </select>
                                        </div>
                                    </div>
                                     <div class="col-md-6">
                                        <div class="mb-1">
                                            ...
                                            <select class="form-select select2" id="zona" multiple="multiple">
