                                ...
                                <thead>
                                    <tr> <th></th>     
                                        ...
                                        <th></th>                                            <!-- Para chofer_nombre (índice 4) -->                                      
                                                                          <!-- Para ayudante_nombre (índice 5) -->  
                                                                                 <!-- ¡ESTE ES EL <th> QUE FALTABA! Para la columna de Acciones (índice 10) -->
                                    </tr>
                                </thead>
                                    ...
                                    <div class="modal-dialog sidebar-sm">
                                        <form class="add-new-record modal-content pt-0">
                                            ...
                                            <div class="modal-body flex-grow-1">                                                  
                                                ...
                                                <button type="button" class="btn btn-relief-primary data-submit cargarEmbarcos me-1"> <i data-feather='search'></i> Consultar</button>
