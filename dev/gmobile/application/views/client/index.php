    ...
    <form id="formulario_lineas" name="formulario_lineas" method="post" >
        <div class="card-header bg-white font-weight-bold">
                ...
                <div class="input-group col-md-3 mb-1">
                    ...
                    <input type="text" class="form-control form-control-sm" id="rif" name="rif" placeholder="RIF" value="" data-toggle="tooltip" data-original-title="RIF" onkeyup="consultar();" onkeypress="validarenter_consulta(event);"><!--validarenter_consulta(event)-->
                </div>
...
$('#titlemodule').text('  -> Clientes');

/* Formatting function for row details - modify as you need */
function format ( d ) {
    // `d` is the original data object for the row
    return '<b>RIF:</b> <font color="#6E6E6E">'+d[3]+'</font>'+
    '<br><br><b>DIRECCION:</b> <font color="#6E6E6E">'+d[4]+'</font>'+
    '<br><br><b>TELEFONOS:</b> <font color="#6E6E6E">'+d[5]+'</font>'+
    '<br><br><b>E-MAIL:</b> <font color="#6E6E6E">'+d[6]+'</font>'+
    '<br><br><b>ZONA:</b> <font color="#6E6E6E">'+d[7]+'</font>'+
    '<br><br><b>TIPO:</b> <font color="#6E6E6E">'+d[8]+'</font>'+
    '<br><br><b>DIRECCION DE ENTREGA:</b> <font color="#6E6E6E">'+d[9]+'</font><br><br>';
   ...
   ajax : {
    url:"<?php echo base_url(); ?>client/getclient",
    type:"POST",
    data:{
