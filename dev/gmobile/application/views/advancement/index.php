        ...
        <div class="card-header bg-white font-weight-bold">
                ...
                <div class="col-md-2 mb-1">
                    <div class=" btn-group-sm btnderecha">
                                ...
                                <button type="button" class="btn btn-success" data-toggle="tooltip" data-original-title="Agregar" onclick="add_ade()">&nbsp; <i class="fas fa-plus"></i> &nbsp;</button>
...
<form id="formulario_cobro" name="formulario_cobro" method="multipart/form-data">
    ...
    <div class="form-row">
        <div class="col-md-4 mb-3">
            <label for="npagar">Monto</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <div class="input-group-text"><i class="fa fa-dollar-sign"></i></div>
                </div>
                <input type="text" style="text-align: right;" class="form-control money" id="npagar" name="npagar" placeholder="0" >
            </div>
        </div>
        <div class="col-md-4 mb-3">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control form-control-sm" id="ndocumento" name="ndocumento" placeholder="Nº Documento">
            </div>
        </div>
        <div class="col-md-4 mb-3">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control form-control-sm datepicker" id="nfecha" name="nfecha" value="<?php echo date('d-m-Y');?>" placeholder="dd-mm-yyyy">
            </div>
        </div>
    </div>
    <div class="form-row">
        <div class="col-md-4 mb-3">
            <label for="nfpago">Forma de pago</label>
            <div class="input-group">
            <div class="input-group-prepend">
                        <div class="input-group-text"><i class="fa fa-list"></i></div>
                    </div>
                    <select class="form-control form-control-sm" id="nfpago" name="nfpago">
                        <?php 
        ...
        <div class="col-md-4 mb-3">
            <label for="ncta">Cuenta</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <div class="input-group-text"><i class="fa fa-list"></i></div>
                </div>
                <select class="form-control" id="ncta" name="ncta" onchange="cambio_cta();">
        ...
        <div class="col-md-4 mb-3">
            ...
            <div class="input-group">
                ...
                <select class="form-control" id="nbanco" name="nbanco" onchange="cambio_banco();">
                        <option value="">Seleccione..</option>
                        <?php 
    ...
    <div class="form-row">
        <div class="col-md-12 mb-3">
            <label for="nobserva">Observaci&oacute;n</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <div class="input-group-text"><i class="fa fa-address-card"></i></div>
                </div>
                <input type="text" class="form-control form-control-sm" id="nobserva" name="nobserva" placeholder="Observaci&oacute;n" >
            </div>
        </div>
    </div>
    <div class="form-row">
    ...
    <input type="hidden" id="nco_ven" name="nco_ven" value="<?php echo $co_ven?>">
...
function format ( d ) {
   ...
   ajax : {
    url:"<?php echo base_url(); ?>advancement/getclient",
    type:"POST",
    data:{
...
function subir(co_cob){
	$('.modal-body6').load('<?php echo base_url(); ?>advancement/imagen/'+co_cob,function(){
...
function save_img(){
    ...
    var id=$('#ecodigo1').val();
    var url;
    url = "<?php echo base_url(); ?>advancement/imagensave";
...
function anular2(){
    ...
    var url;
        url = "<?php echo base_url(); ?>advancement/anular/"+codigo;
    // ajax adding data to database
    $.ajax({
        url : url,
        type: "GET",
...
function add_ade(){
    ...
    document.getElementById('npagar').focus(); 
}
...
function validaForm(){
    // Campos de texto
    if($("#npagar").val() == ""){
        error_msg("El campo Monto no puede estar vacío.");
        $("#npagar").focus();
        return false;
    }
    if($("#npagar").val() == 0){
...
function save_cobro(){
    if(validaForm()){
            var url;
        url = "<?php echo base_url(); ?>advancement/save_cobro";
    // ajax adding data to database
    $.ajax({
        url : url,
        type: "POST",
...
function cambiar_bd(){
    ...
    function cambio_cta(){
        var banco=$("#ncta option:selected").attr("data-id");
        $('[name="nbanco"]').val(banco);
    }
