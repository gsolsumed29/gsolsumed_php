    ...
    <form id="formulario_lineas" name="formulario_lineas" method="post" >
        <div class="card-header bg-white font-weight-bold">
                ...
                <div class="input-group col-md-3 mb-1">
                    ...
                    <input type="text" class="form-control form-control-sm" id="codigo" name="codigo" placeholder="Codigo" value="" data-toggle="tooltip" data-original-title="Codigo" onkeyup="consultar();" onkeypress="validarenter_consulta(event);">
                </div>
...
$('#titlemodule').text('  -> Articulos');

/* Formatting function for row details - modify as you need */
function format ( d ) {
    // `d` is the original data object for the row
    return '<b>PRECIO:</b> <font color="#6E6E6E">'+d[3]+'</font><br>'+
    //'<br><b>STOCK REAL:</b> <font color="#6E6E6E">'+d[4]+'</font><br>'+
   // '<br><b>STOCK COMPROMETIDO:</b> <font color="#6E6E6E">'+d[11]+'</font><br>'+
    '<br><b>STOCK DISPONIBLE:</b> <font color="#6E6E6E">'+d[12]+'</font><br>'+
   '<br><b>TIPO:</b> <font color="#6E6E6E">'+d[5]+'</font><br>';//+
    //'<br><b>IMPUESTO:</b> <font color="#6E6E6E">'+d[6]+'</font><br>'+
    //'<br><b>PRECIO 2:</b> <font color="#6E6E6E">'+d[7]+'</font><br>'+
    //'<br><b>PRECIO 3:</b> <font color="#6E6E6E">'+d[8]+'</font><br>'+
    //'<br><b>PRECIO 4:</b> <font color="#6E6E6E">'+d[9]+'</font><br>'+
    //'<br><b>PRECIO 5:</b> <font color="#6E6E6E">'+d[10]+'</font><br><br>';
}
   ...
   ajax : {
    url:"<?php echo base_url(); ?>articles/getarticles",
    type:"POST",
    data:{
     codigo: function() { return $('#codigo').val() },
     nombre: function() { return $('#nombre').val() },
     sucu: function() { return $('#co_alma').val() }
    }
   }
    } );
