    ...
    <form id="formulario_lineas" name="formulario_lineas" method="post" >
        ...
        <div class="card-body">
            ...
            <thead>
                <tr>
                    <th></th>
                    <th>NO VISITADOS EN UN PERIODO</th>
                    <!--<th>CODIGO</th>
                    <th>NOMBRE</th>
                    <th>RIF</th>-->
                    <!--<th>DIRECCION</th>
...
function format ( d ) {
    ...
    '<br><b>F. REGISTRO:</b> <font color="#6E6E6E">'+d[6]+'</font><br>'+
    '<br><b>ZONA:</b> <font color="#6E6E6E">'+d[7]+'</font><br>'+
    '<br><b>NUEVO:</b> <font color="#6E6E6E">'+d[8]+'</font><br><br>';
}
   ...
   ajax : {
    url:"<?php echo base_url(); ?>nvxf/getclient",
    type:"POST",
    data:{
