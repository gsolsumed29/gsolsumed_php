...
<html lang="es" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>Recuperar Contraseña | Grupo Solsumed, CA</title>
      ...
      <style>
         ...
         /* Estilos específicos para el formulario de recuperación */
  ...
  <body class="sidebar-mini sidebar-default" data-bs-spy="scroll" data-bs-target="#elements-section" data-bs-offset="0" tabindex="0">
         ...
         <div class="col-md-6">
               <div class="row justify-content-center">
                 ...
                 <img src="app-assets/images/pages/logo_texto_grupo_solsumed.webp" alt="Logo Grupo solsumed" class="img-fluid" style="max-width: 300px;">
                           ...
                           <form class="auth-login-form" id="forgot-form" action="#" method="POST" novalidate>
                              <div class="row">
                                 <div class="col-lg-12">
                              ...
                              <div class="login-spinner" id="loginSpinner">
                                 ...
                                 <p class="mt-2">Enviando instrucciones...</p>
                              </div>                           
                           </form>
...
<!-- Primero: jQuery (fundamental) -->
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>

<!-- Segundo: Swiper JS (DEBE IR ANTES de tu código que lo usa) -->
<script src="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js"></script>

<!-- Tercero: Plugin de validación -->
...
<!-- Quinto: Scripts específicos de forgot password -->
<script src="core/assets/js/forgot.js"></script>

<!-- Sexto: Script principal con tu código, asegurándote de que Swiper ya está cargado -->
<script>
    // Interceptar errores para debugging
    window.addEventListener('error', function(e) {
        if (e.filename && e.filename.includes('vendors.min.js')) {
            console.warn('Error en vendors.min.js interceptado:', {
                error: e.error,
                message: e.message,
                filename: e.filename,
                lineno: e.lineno,
    ...
    function initializeAll() {
        ...
        // Verificar que Swiper esté definido antes de usarlo
        if (typeof Swiper !== 'undefined') {
            console.log('Swiper está disponible, inicializando...');
            ...
            console.error('Swiper no está definido. Verifica que la librería se cargó correctamente.');
        }
        
        // Cargar otros scripts adicionales si son necesarios
        setTimeout(function() {
            const scriptsToLoad = [
                'app-assets/js/core/app-menu.js',
                'app-assets/js/core/app.js',
                'core/assets/js/core/libs.min.js',
                'core/assets/js/core/external.min.js',
                'core/assets/js/hope-ui.js'
            ];
            
            scriptsToLoad.forEach(function(src) {
                // Cargar scripts de manera asíncrona si son necesarios
                console.log('Cargando script adicional: ' + src);
