    ...
    <?php 
      ...
      $result = $objeto_pedido->GetFacturaDetalles($fact_num,$status);
      //var_dump($result);
      if(!empty($result)){
                ...
                <section class="invoice-preview-wrapper">
                    <div class="row invoice-preview" >
                        ...
                        <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
                            <div class="card">
                                <div class="card-body">                                    
                                <a class="btn btn-success w-100 mb-75" href="index.php?action=reportePedido&fact_num=<?php echo $fact_num; ?>" target="_blank"> Generar Pdf </a>                                  
                                <?php if(!isset($status)==0){
                                    ?>
                                    <button class="btn btn-info w-100 mb-75 " id = "">
                                    Asignar Pago <span class="total_articulos_eliminar" style="display:none"><?php echo $totalArticulos; ?> <span class="fact_num_eliminar" style="display:none"><?php echo $fact_num; ?></span>
                                    </button>  

                                    <button class="btn btn-warning w-100 mb-75 " id = "">
                                    Anular Factura <span class="total_articulos_anular" style="display:none"><?php echo $totalArticulos; ?> <span class="fact_num_anular" style="display:none"><?php echo $fact_num; ?></span>
                                    </button>   
                                  
                                    <button class="btn btn-danger w-100 mb-75 " id = "">
                                    Eliminar Factura <span class="total_articulos_eliminar" style="display:none"><?php echo $totalArticulos; ?> <span class="fact_num_eliminar" style="display:none"><?php echo $fact_num; ?></span>
                                    </button>     
