  <!-- BEGIN: Content-->
  <div class="app-content content m_aprobaciones">
        ...
        <div class="content-wrapper container-xxl p-0">
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Aprobaciones </h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"> <span class="s" id="s" style="display:none"><?php echo $_GET['s']?></span> Aprobaciones
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
               ...
               <input type="hidden" id="dataAprobaciones" class="dataAprobaciones" value=''>
                <!-- Basic table -->
                <section id="basic-datatable">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <table class="datatables-basic-aprobaciones table">
                                    <thead>
                                        <tr>
                                    ...
                                    <div class="modal-dialog sidebar-sm">
                                        <form class="add-new-record modal-content pt-0">
                                            ...
                                            <div class="modal-body flex-grow-1">                                          
                                                ...
                                                <div class="mb-1">
                                                    <label class="form-label" for="basic-icon-default-date">Estatus de la aprobaciòn</label>
                                                ...
                                                <button type="button" class="btn btn-relief-primary data-submit cargarAprobaciones me-1"> <i data-feather='search'></i> Consultar</button>
