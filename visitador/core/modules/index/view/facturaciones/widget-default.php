  <!-- BEGIN: Content-->
  <div class="app-content content m_facturaciones">
        ...
        <div class="content-wrapper container-xxl p-0">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"> <span class="s" id="s" style="display:none"><?php echo $_GET['s']?></span> Facturas
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
               ...
               <input type="hidden" id="dataFacturaciones" class="dataFacturaciones" value=''>
                <!-- Basic table -->
                <section id="basic-datatable">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <table class="datatables-basic-facturaciones table">
                                    <thead>
                                        <tr>
                                    ...
                                    <div class="modal-dialog sidebar-sm">
                                        <form class="add-new-record modal-content pt-0">
                                            ...
                                            <div class="modal-body flex-grow-1">                                          
                                                ...
                                                <button type="button" class="btn btn-relief-primary data-submit cargarFacturaciones me-1"><i data-feather='search'></i> Consultar</button>
