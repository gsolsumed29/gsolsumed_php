            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Candidato</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"> Ficha del candidato
                                    </li>
                                </ol>
                            </div>
                        </div>
             ...
             <div class="card">
                ...
                <div class="card-body p-1">
                    <form class="validate-form">
                            ...
                            <div class="row g-2">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="cli_des" name="cli_des"  value = "<?php echo $_GET['cand_des'] ?>" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                        ...
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control input-group-sm" id="cli_rif" name="cli_rif" 
                                                maxlength="10" placeholder="Ej: J123456789" value = "<?php echo $_GET['co_cli'] ?>" disabled>
                                        </div>
                        ...
                        <div class="mb-1">
                            ...
                            <div class="row g-2">
                                <div class="col-md-6">
                                    ...
                                    <div id="previewContainer" class="mt-3" <?php echo $_GET['foto_url'] ? '' : 'style="display: none;"'; ?>>
                                        <div class="card">
                                            <div class="card-header bg-light">
                                                <h6 class="mb-0">Foto Principal del local</h6>
                                            </div>
                                            <div class="card-body text-center">
                                                <img id="previewImage" src="<?php echo $_GET['foto_url'] ? $_GET['foto_url'] : '#'; ?>" 
                        ...
                        <div class="mb-1">
                            <h5 class="text-primary mb-1"><i data-feather='flag'  class="me-1"></i> Recepción</h5>
                            <div class="row g-2">
                               
                                  <div class="col-md-6">
                                    <label class="form-label fw-bold">Persona de contacto <span class="text-danger">*</span></label>
                                    ...
                                    <div class="input-group input-group-sm">
                                     ...
                                     <div class="col-md-6">
                                    <label class="form-label fw-bold">Telefono contacto <span class="text-danger">*</span></label>
                                    <div class="input-group input-group-sm">
                        ...
                        <!-- Ubicación -->
                        <div class="mb-1">
                            <h5 class="text-primary mb-1"><i data-feather='message-square' class="me-1"></i> Observaciónes</h5>
                            <div class="row g-2 mb-2">
                                <div class="col-12">
                                    <label class="form-label fw-bold">Apreciación general de la visita </label>
                                    <textarea class="form-control form-control-sm" rows="3" id="cli_direccion" name="cli_direccion" ></textarea>
                                </div>
                        ...
                        <div class="d-flex justify-content-end border-top pt-2 mt-2">
                            ...
                            <button type="button" class="btn btn-sm btn-primary" id="btnGuardarVisitaCandidato">
