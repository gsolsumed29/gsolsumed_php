                            ...
                            <div class="card-body ">
                                ...
                                <form class="update-record-empresa mt-2 pt-50">
                                    <div class="row dataCorreo">
                                        ...
                                        <div class="col-12">
                                            <button type="button" class="btn btn-relief-primary mt-1 me-1 btnActualizarEmpres"> <i data-feather='save'></i> Guardar Cambios</button>
                                            <button type="button" class="btn btn-relief-info mt-1 me-1 btnEnviarCorreo"> <i data-feather='wifi'></i> Probar envio</button>
                                        </div>
                                    </div>
                                </form>
                                <!--/ form -->
