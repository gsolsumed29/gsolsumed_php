...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static   menu-collapsed user" data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                    ...
                    <img class="logo_aurora_layaut d-none " src="../app-assets/images/ico/logo_texto_2.png"  alt="GRUPO SOLSUMED">
                       <img class="logo_aurora_layaut_single" src="../app-assets/images/ico/logo_solo.png" alt="GRUPO SOLSUMED" >
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather='users'></i><span class="menu-title text-truncate" data-i18n="Card">Personas</span></a>
                    <ul class="menu-content">                
                       
                        <li><a class="d-flex align-items-center" href="index.php?view=vendedores"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Vendedores</span></a>
                        </li>  
                        <li><a class="d-flex align-items-center" href="index.php?view=users"><i data-feather='circle'></i><span class="menu-title text-truncate" data-i18n="Card">Usuarios</span></a>    
                        </li>           
                    </ul>                  
                </li>
               
             
                <li><a class="d-flex align-items-center" href="index.php?view=empresa"><i data-feather='settings'></i><span class="menu-title text-truncate" data-i18n="Card">Empresa</span></a>    
                </li>
                <li><a class="d-flex align-items-center" href="index.php?view=email"><i data-feather='send'></i><span class="menu-title text-truncate" data-i18n="Card">Correo electrónico</span></a>    
                </li>     
                
                 <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather='bar-chart-2'></i><span class="menu-title text-truncate" data-i18n="Card">Indicadores</span></a>
                    <ul class="menu-content">                
                       
                        <li><a class="d-flex align-items-center" href="index.php?view=tipos"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Tipos</span></a>
                        </li>  
                        <li><a class="d-flex align-items-center" href="index.php?view=parametros"><i data-feather='circle'></i><span class="menu-title text-truncate" data-i18n="Card">Parametros</span></a>    
                        </li>           
                    </ul>                  
                </li>
