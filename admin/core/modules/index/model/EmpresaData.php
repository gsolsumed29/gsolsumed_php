...
class EmpresaData {
	...
	public function update(){
		$sql = "UPDATE ".self::$tablename." SET name='$this->name', email='$this->email',email_ventas='$this->email_ventas',email_cobros='$this->email_cobros', dir='$this->dir', telefonos='$this->telefonos',rif='$this->rif'  WHERE co_emp='01';";
		//echo $sql;
		$query = Executor::doitEx($sql);
	}

	public function updateCorreo(){
		$sql = "UPDATE jm_empresa_email SET text='$this->text', smtp='$this->smtp', password='$this->password', host='$this->host',port='$this->port'  WHERE co_emp='01';";
		//echo $sql;
		$query = Executor::doitEx($sql);
	}
