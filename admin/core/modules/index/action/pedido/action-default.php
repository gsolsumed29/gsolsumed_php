        ...
        if($datos==1){       
          $saldo = $_GET['saldo'];              
           ...
           // $data2=$funciones_objeto->validarDiasFacturas($co_cli);
            ...
            $data2=$funciones_objeto->validarFacturasDiasVencidos($co_cli);
             ...
             if(empty($data2)){
              ...
              $pedido_objeto->observacion =$observacion;
              $pedido_objeto->total_art =$total_art;
              $pedido_objeto->dato1 =$mont_comi;

              $pedido_objeto->tipo_precio = $tipo_precio;
              $pedido_objeto->facturacion = $facturacion;
              $pedido_objeto->pago = $pago;
              ...
              $ven_des  =$_SESSION['nombre'];
             
              $fecha = date('d/m/Y');

             $Menssage ="<p>Nombre del cliente: <b> ".$cli_des." </b></p>";
             $Menssage.="<p>Nro Pedido :<b> ".$fact_num."</b> </p>";             
             $Menssage.="<p>Total neto $ :<b> ".$total_neto."</b> </p>";
             $Menssage.="<hr>";
             $Subject =  $ven_des.'-'.$co_ven.'-'.$cli_des.'-Nro:'.$fact_num.'-'.$fecha;
              ...
              $cotizacion_objeto->dato1 =$mont_comi;
