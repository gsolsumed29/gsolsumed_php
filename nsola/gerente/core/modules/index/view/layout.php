...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static   menu-collapsed user localizacion" data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-light navbar-shadow container-xxl">        
        ...
        <div class="bookmark-wrapper d-flex align-items-center">
                ...
                <h4 class="brand-text name" id="name"></h4>
                </ul>
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto"><a class="navbar-brand" href="./">
                    <img class="logo_aurora_layaut" src="../app-assets/images/ico/logo.png" alt="jmobile ver 1.0">
                        <h2 class="brand-text name" id="">jmobile ver 1.0</h2>
                    </a>
                </li>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather='bar-chart-2'></i><span class="menu-title text-truncate" data-i18n="User">Reportes</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Second Level">Ventas</span></a>
                            <ul class="menu-content">
                                <li><a class="d-flex align-items-center" href="index.php?view=reportevxa"><span class="menu-item text-truncate" data-i18n="Third Level">Articulo</span></a>
                                </li>
                                <li><a class="d-flex align-items-center" href="index.php?view=reportevxl"><span class="menu-item text-truncate" data-i18n="Third Level">Linea</span></a>
                                </li>
                                <li><a class="d-flex align-items-center" href="index.php?view=reporteavcto"><span class="menu-item text-truncate" data-i18n="Third Level">Analisis de Vcto</span></a>
                                </li>
                            </ul>
                        </li>                        
...
?>
  ...
  <!-- BEGIN: Footer-->
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2023<a class="ms-25" href="#" target="_blank">Soluciones Jm</a><span class="d-none d-sm-inline-block">, Reservados todos los derechos</span></span><span class="float-md-end d-none d-md-block">jmobile ver 1.0<i data-feather="heart"></i></span></p>
    </footer>
    ...
    if (document.getElementById("reporteGerencial") !== null) {
    ...
    $boton.addEventListener("click", () => {
        ...
        html2pdf()
            .set({
                margin: 0.5,
                filename: 'reporte_gerencial.pdf',
                image: {
                    type: 'jpeg',
                    quality: 0.98
                },
