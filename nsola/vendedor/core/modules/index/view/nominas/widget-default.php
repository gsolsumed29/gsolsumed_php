  ...
  <div class="app-content content m_pedidos">
        ...
        <div class="content-wrapper container-xxl p-0">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="index.php?view=nominas">Nominas</a>
                                    </li>
            ...
            <div class="content-body">
               ...
               <input type="hidden" id="dataPedidos" class="dataPedidos" value=''>
                <!-- Basic table -->
                <section id="basic-datatable">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <table class="datatables-basic-pedidos table">
                                    <thead>
                                        <tr>
