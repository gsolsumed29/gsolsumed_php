                ...
                <section class="invoice-preview-wrapper">
                    <div class="row invoice-preview" >
                                        ...
                                        <?php 
                                           ...
                                           foreach($result2 as $dato){
                                            ...
                                            ?>
                                                ...
                                                <td class="py-1">
                                                    <span class="fw-bold"><?php echo number_format($cantidad, 2, ',', '.');?></span>
                                                </td>
                                                <td class="py-1">
                        ...
                        <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
                            <div class="card">
                                <div class="card-body">                                    
                                <a class="btn btn-success w-100 mb-75" href="index.php?action=reporte&tipo=6&fact_num=<?php echo $fact_num; ?>&status=<?php echo $status; ?>" target="_blank"> Generar Pdf </a>                                  
                                <?php if(isset($status)){
                                        if($status==0){
                                    ?>
                                    
                                  
                                    <button class="btn btn-danger w-100 mb-75 eliminarAprobacion" id = "eliminarAprobacion">
                                    Eliminar Aprobación <span class="total_articulos_eliminar" style="display:none"><?php echo $totalArticulos; ?> <span class="fact_num_eliminar" style="display:none"><?php echo $fact_num; ?></span>
                                    </button>                                                             
                                     <?php
                                        }
                                }
